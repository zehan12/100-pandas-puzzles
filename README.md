...
### [Puzzles notebook](https://github.com/zehan12/100-pandas-puzzles/blob/master/100-pandas-puzzles.ipynb)
### [Solutions notebook](https://github.com/zehan12/100-pandas-puzzles/blob/master/100-pandas-puzzles-with-solutions.ipynb)
...
```
git clone https://github.com/zehan12/100-pandas-puzzles.git
```
...
This repository has benefitted from numerous contributors, with those who have sent puzzles and fixes listed in [CONTRIBUTORS](https://github.com/zehan12/100-pandas-puzzles/blob/master/CONTRIBUTORS.md).
